...
from bheem_core.modules.auth.core.services.permissions_service import get_current_company_id
...
from bheem_core.modules.hr.core.schemas.hr_schemas import OfferCreate, OfferResponse, OfferUpdate
