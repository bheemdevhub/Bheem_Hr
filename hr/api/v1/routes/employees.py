...
from app.shared.schemas import ContactCreate, ContactResponse
from app.shared.models import EmploymentTypeEnum, EmploymentStatusEnum
...
async def activate_employee(
    ...
    from app.modules.hr.core.schemas.hr_schemas import EmployeeUpdate
    hr_service = HRService(db, event_bus=None)
    try:
